    ...
    return (
        <div className="relative w-full min-h-screen overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center text-white px-4 py-8 w-full h-screen">
                ...
                <h2 className="mt-3 text-3xl md:text-4xl lg:text-5xl font-bold drop-shadow-lg">
                    Model United Nations
                </h2>

                <p className="mt-5 text-lg md:text-xl lg:text-2xl max-w-2xl drop-shadow-lg font-serif italic">
                    Most International MUN in Hong Kong
                </p>
                <p className="mt-2 text-sm md:text-base lg:text-lg drop-shadow-md">
                    Apr 11 - Apr 13, 2025
                </p>
