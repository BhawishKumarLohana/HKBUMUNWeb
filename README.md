...
We deploy and host our website using **Vercel**, which directly integrates with GitHub for seamless deployment and automatic configuration.

## Getting Started

To contribute to the HKBU MUN website or to run it locally, follow these steps:

1. Clone the repository
2. cd hkbu-mun-website
3. npm install
4. npm run dev
